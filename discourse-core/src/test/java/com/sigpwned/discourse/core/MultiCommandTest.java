...
public class MultiCommandTest {
  ...
  // public void
  // givenMultiCommandWithOneCommonParameter_whenComputeCommonParameters_thenFindOneCommonParameter()
  // {
  ...
  // @Ignore("I'm not sure if this is still relevant...")
  // public void
  // givenMultiCommandWithThreeDeepParameters_whenComputeDeepParameters_thenFindThreeDeepParameters()
  // {
  ...
  // public void
  // givenMultiCommandWithTwoSubcommands_whenRetrieveSubcommands_thenFindTwoSubcommands() {
  //// MultiCommand<MultiExample> resolvedCommand = (MultiCommand<MultiExample>) Command.scan(
  //// MultiExample.class);
  ////
