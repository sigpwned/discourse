...
public class DiscriminatorCommandSynopsisEntryTextFormatter implements SynopsisEntryFormatter {
  @Override
  public Optional<String> formatSynopsisEntry(PlannedCommand<?> command, CommandSynopsisEntry entry,
      InvocationContext context) {
    if (!(entry instanceof DiscriminatorCommandSynopsisEntry discriminatorEntry))
