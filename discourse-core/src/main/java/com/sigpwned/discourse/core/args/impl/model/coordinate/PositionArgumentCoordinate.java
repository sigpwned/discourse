package com.sigpwned.discourse.core.args.impl.model.coordinate;

import java.util.Objects;

public final class PositionArgumentCoordinate extends ArgumentCoordinate implements
    Comparable<PositionArgumentCoordinate> {
