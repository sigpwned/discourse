 ...
 *
 * <ul>
 * <li>{@link com.sigpwned.discourse.core.module.core.plan.value.sink.AssignValueSinkFactory Overwrite}</li>
 * <li>{@link com.sigpwned.discourse.core.module.core.plan.value.sink.ArrayAppendValueSinkFactory Collect in
 * array}</li>
 * <li>{@link com.sigpwned.discourse.core.module.core.plan.value.sink.ListAddValueSinkFactory Collect in
 * List}</li>
 * <li>{@link com.sigpwned.discourse.core.module.core.plan.value.sink.SetAddValueSinkFactory Collect in
 * Set}</li>
 * <li>{@link com.sigpwned.discourse.core.module.core.plan.value.sink.SortedSetAddValueSinkFactory Collect in
 * SortedSet}</li>
 * </ul>
 */
