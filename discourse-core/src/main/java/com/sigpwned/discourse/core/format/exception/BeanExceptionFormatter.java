...
public class BeanExceptionFormatter implements ExceptionFormatter {
  ...
  public void formatException(Throwable e, InvocationContext context) {
    ...
    // In this case, there was a problem building the resolvedCommand object. This is probably a bug in
    ...
    err.println("There was a problem building the resolvedCommand object.");
