...
public class ShortOptionUnixArgFormatter implements ArgFormatter, UnixDialectElement {
  @Override
  public Optional<List<List<String>>> formatArg(PlannedCommandProperty property,
    ...
    return Optional.of(List
        .of(List.of(SHORT_NAME_PREFIX + option.getName(), "<" + UserMessages.render(type) + ">")));
  }
}
