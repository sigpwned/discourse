...
public class DuplicateCoordinatesScanException extends ScanException {
  ...
  public DuplicateCoordinatesScanException(Class<?> clazz, Set<String> coordinates) {
    super(format("Configuration %s coordinates %s appear on multiple parameters", clazz.getName(),
        coordinates));
    ...
    if (coordinates.isEmpty()) {
      ...
      throw new IllegalArgumentException("no coordinates");
    }
  }
